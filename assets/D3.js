...
for (let i2 = 0; i2 < starWarsCharacters.length; i2++) {
  ...
  femaleCharacter.push(starWarsCharacters[i2]);
  }
}
...
switch(starWarsCharacters) {
  case 1:
    eye_Color.blue.push in  eyeColor.blue
    case 2:
    eye_Color.yellow.push in eyeColor.yellow
    case 3:
    eye_Color.brown.push in eyeColor.brown
    case 4:
    eye_Color.red.push in eyeColor.red
    case 5:
}
